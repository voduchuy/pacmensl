    ...
    namespace petsc {
        ...
        public:
            ...
            Magnus4FSP(MPI_Comm _comm, Real _t_start, Real _t_final, TMVFun _tmatvec, Vec _v, Int _n_sinks,
                       ...
                       Real _tol = 1.0e-4,
                       Int _m = 30,
                       bool _iop = true, Int _q_iop = 2, Real _kry_tol = 1.0e-8, Real _anorm = 1.0) :
                    comm(_comm),
                    t_start(_t_start),
                    t_final(_t_final),
                    tmatvec(_tmatvec),
            ...
            */
            ...
            void update_vector(Vec _v, TMVFun _tmatvec) {
                ...
                expv = KExpv(comm, t_final, [this](Vec x, Vec y) { magnus_mv(x, y, this); }, _v, m_krylov, kry_tol);
                ...
                PetscPrintf(MPI_COMM_SELF, "Sink indices created. \n");
