...
#ifndef PARALLEL_FSP_STATESETPARTITIONERBASE_H
#define PARALLEL_FSP_STATESETPARTITIONERBASE_H
...
namespace cme {
    namespace parallel {
        ...
        protected:
            ...
            float *states_weights_; ///< Computational weights associated with each state, here we assign to these weights the number of FLOPs needed
...
#endif //PARALLEL_FSP_STATESETPARTITIONERBASE_H
