...
namespace cme {
    namespace parallel {
        ...
        void
        FspMatrixConstrained::generate_matrices( cme::parallel::StateSetConstrained &fsp, const arma::Mat< int > &SM,
                                                 cme::parallel::PropFun prop, cme::parallel::TcoefFun new_t_fun ) {
            PetscErrorCode ierr;
