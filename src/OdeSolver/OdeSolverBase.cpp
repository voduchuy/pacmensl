...
void cme::parallel::OdeSolverBase::set_print_intermediate( int iprint ) {
...
namespace cme{
    namespace parallel{
        ...
        FiniteProblemSolverPerfInfo OdeSolverBase::get_avg_perf_info( ) {
            assert(logging);
        ...
        void OdeSolverBase::set_stop_condition( const std::function< int( PetscReal, Vec, void * ) > &stop_check_, void* stop_data_ ) {
