...
namespace pacmensl {
    ...
    void StateSetBase::SetInitialStates( int num_states, int *vals ) {
        arma::Mat< int > X0( vals, num_species_, num_states, false, false );
        AddStates( X0 );
    }
    ...
    void StateSetBase::AddStates( int num_states, int *vals ) {
        arma::Mat< int > X( vals, num_species_, num_states, false, false );
        AddStates( X );
    }
